...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20250423171019_IdentityMigrations2")]
    partial class IdentityMigrations2
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ApplicationUserIdentityUserRole<string>", b =>
                {
                    b.Property<string>("ApplicationUserId")
                        .HasColumnType("text");

                    b.Property<string>("RolesUserId")
                        .HasColumnType("text");

                    b.Property<string>("RolesRoleId")
                        .HasColumnType("text");

                    b.HasKey("ApplicationUserId", "RolesUserId", "RolesRoleId");

                    b.HasIndex("RolesUserId", "RolesRoleId");

                    b.ToTable("ApplicationUserIdentityUserRole<string>");
                });
            ...
            modelBuilder.Entity("Domain.Entities.Bracket", b =>
                {
                    ...
                    b.Property<long?>("BronzeMedalistParticipantId")
                        .HasColumnType("bigint");
                    ...
                    b.Property<long?>("GoldMedalistParticipantId")
                        .HasColumnType("bigint");

                    b.Property<long?>("JoinBronzeMedalistParticipantId")
                        .HasColumnType("bigint");
                    ...
                    b.Property<long?>("SilverMedalistParticipantId")
                        .HasColumnType("bigint");
                    ...
                    b.HasIndex("BronzeMedalistParticipantId");

                    b.HasIndex("CompetitionId");

                    b.HasIndex("GoldMedalistParticipantId");

                    b.HasIndex("JoinBronzeMedalistParticipantId");

                    b.HasIndex("SilverMedalistParticipantId");
            ...
            modelBuilder.Entity("Domain.Entities.Match", b =>
                {
                    ...
                    b.Property<bool>("IsFirstParticipantBye")
                        .HasColumnType("boolean");

                    b.Property<bool>("IsSecondParticipantBye")
                        .HasColumnType("boolean");
            ...
            modelBuilder.Entity("ApplicationUserIdentityUserRole<string>", b =>
                {
                    ...
                    b.HasOne("Microsoft.AspNetCore.Identity.IdentityUserRole<string>", null)
                        .WithMany()
                        .HasForeignKey("RolesUserId", "RolesRoleId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("Domain.Entities.Bracket", b =>
                {
                    b.HasOne("Domain.Entities.Participant", "BronzeMedalistParticipant")
                        .WithMany()
                        .HasForeignKey("BronzeMedalistParticipantId")
                    ...
                    b.HasOne("Domain.Entities.Participant", "GoldMedalistParticipant")
                        .WithMany()
                        .HasForeignKey("GoldMedalistParticipantId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("Domain.Entities.Participant", "JoinBronzeMedalistParticipant")
                        .WithMany()
                        .HasForeignKey("JoinBronzeMedalistParticipantId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("Domain.Entities.Participant", "SilverMedalistParticipant")
                        .WithMany()
                        .HasForeignKey("SilverMedalistParticipantId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.Navigation("BronzeMedalistParticipant");

                    b.Navigation("Competition");

                    b.Navigation("GoldMedalistParticipant");

                    b.Navigation("JoinBronzeMedalistParticipant");

                    b.Navigation("SilverMedalistParticipant");
                });
            ...
            modelBuilder.Entity("Domain.Entities.Match", b =>
                {
                    b.HasOne("Domain.Entities.Bracket", "Bracket")
                        .WithMany("Matches")
                    ...
                    b.HasOne("Domain.Entities.Match", "NextMatch")
