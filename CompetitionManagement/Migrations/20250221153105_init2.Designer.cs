...
namespace CompetitionManagement.Migrations
{
    ...
    [Migration("20250221153105_init2")]
    partial class init2
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CompetitionManagement.Domain.Entities.AgeGroup", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                    ...
                    b.Property<long>("CompetitionDefinitionId")
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("CompetitionManagement.Domain.Entities.CompetitionDefinition", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.Property<long>("CertificateImageId")
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("CompetitionManagement.Domain.Entities.CompetitionTableDetail", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.Property<long>("CompetitionTableId")
                        .HasColumnType("bigint");
                    ...
                    b.Property<long>("SecondRedCompetitionRegisterId")
                        .HasColumnType("bigint");
                    ...
                    b.HasIndex("SecondRedCompetitionRegisterId");
            ...
            modelBuilder.Entity("CompetitionManagement.Domain.Entities.AgeGroup", b =>
                {
                    b.HasOne("CompetitionManagement.Domain.Entities.CompetitionDefinition", "CompetitionDefinition")
                        .WithMany("AgeGroups")
            ...
            modelBuilder.Entity("CompetitionManagement.Domain.Entities.Competition", b =>
                {
                    b.HasOne("CompetitionManagement.Domain.Entities.AgeGroup", "AgeGroup")
                        .WithMany()
            ...
            modelBuilder.Entity("CompetitionManagement.Domain.Entities.CompetitionTableDetail", b =>
                {
                    b.HasOne("CompetitionManagement.Domain.Entities.Competition", "Competition")
                        .WithMany("CompetitionTableDetails")
                    ...
                    b.HasOne("CompetitionManagement.Domain.Entities.CompetitionRegister", "SecondRedCompetitionRegister")
                        .WithMany()
                        .HasForeignKey("SecondRedCompetitionRegisterId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
                    ...
                    b.Navigation("SecondRedCompetitionRegister");
                });
            ...
            modelBuilder.Entity("CompetitionManagement.Domain.Entities.Competition", b =>
                {
                    b.Navigation("CompetitionTableDetails");
                });
